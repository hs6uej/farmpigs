      ...
      result = [...result].sort((a, b) => {
        ...
        switch (sortField) {
          ...
          case 'breed':
            ...
            break;
          case 'age':
            // Sort by birthDate (younger = higher timestamp, older = lower timestamp)
            // If we want "Age" column sorted ASC (youngest first), we sort by birthDate DESC
            // If we want "Age" column sorted DESC (oldest first), we sort by birthDate ASC
            aValue = new Date(a.birthDate).getTime();
            bValue = new Date(b.birthDate).getTime();
            // Invert logic because higher birthDate = lower Age
                ...
                {paginatedSows.map((sow) => (
                  <TableRow key={sow.id} className="hover:bg-gray-50 dark:hover:bg-[#7800A3]/10">
                    ...
                    <TableCell className="hidden sm:table-cell px-1.5 sm:px-2 md:px-4 py-2 sm:py-3 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                      <AgeDisplay dateOfBirth={sow.birthDate} />
                    </TableCell>
                    <TableCell className="px-1.5 sm:px-2 md:px-4 py-2 sm:py-3">
                      <span className={`px-1.5 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium ${sow.status === 'ACTIVE' ? 'bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-200' :
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 h-10 border focus:border-0 rounded-lg bg-gray-50 dark:bg-[#2a2640] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:ring-1 focus:ring-[#7800A3] outline-none ${fieldErrors.tagNumber
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 h-10 border focus:border-0 rounded-lg bg-gray-50 dark:bg-[#2a2640] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:ring-1 focus:ring-[#7800A3] outline-none ${fieldErrors.breed
                    ? 'border-red-500 dark:border-red-500'
                    : 'border-gray-200 dark:border-[#8B8D98]/50 focus:border-[#7800A3]'
                    }`}
              ...
              <div>
                ...
                <DatePicker
                  className={`cursor-pointer w-full h-10 px-3 py-2 border rounded-lg bg-gray-50 dark:bg-[#2a2640] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-[#7800A3] focus:ring-0 focus:ring-[#7800A3] ${fieldErrors.birthDate
                    ? 'border-red-500 dark:border-red-500'
